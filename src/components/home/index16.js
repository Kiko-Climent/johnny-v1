...
const HomeGallery11 = ({images}) => {
  ...
  const lastBackgroundIndex = (index + 3) % images.length;
  ...
  return (
    ...
    >
      <img 
      src={images[lastBackgroundIndex].src}
      alt="last"
      ...
      <motion.img
        ...
        alt="Imagen central"
        className="absolute object-cover aspect-[3/4]"
        ...
        transition={{ duration: 0.2, ease: "easeInOut" }} // Aumentamos la duración en móviles
      />
