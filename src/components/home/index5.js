...
const images = [
  ...
  { src: "/images/image00015.jpeg", coordinates: "31.0522° N, 148.2437° W" },
  { src: "/images/image00036.jpeg", coordinates: "34.0522° N, 118.2437° W" },
  { src: "/images/image00034.jpeg", coordinates: "34.0522° N, 118.2437° W" },
];
...
const HomePage5 = () => {
  ...
  const [isHueRotated, setIsHueRotated] = useState(false);
  ...
  const handleClick = () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        setIsHueRotated(false); // Quita el efecto después de un tiempo
      }, 400);
